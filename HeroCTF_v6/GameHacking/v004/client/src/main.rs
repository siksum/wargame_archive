...
async fn create_enemy_vector(world : &mut World) -> Vec<Enemy>
{
    ...
    // 4 (10hp) at (130, 25)
    // 1 (20hp) at (61, 59)
    let smol_nmi = (vec2(33., 20.), 2);
    let mild_nmi = (vec2(20., 60.), 4);
    let solid_nmi = (vec2(130., 25.), 10);
    let boss_nmi = (vec2(61., 59.), 20);
    ...
    client::declare_enemies(&enemy_vector).await;
    
    enemy_vector
}

#[macroquad::main("Giam v0.04")]
async fn main() 
{
    ...
    let mut nmi_vec = create_enemy_vector(&mut world).await;
